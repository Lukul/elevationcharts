...
def plot_elevation_chart(x_track, y_track, waypoint_indicies, annotations, rows=1, pages=6):
	...
	for i in range(pages):
		plot_single_pdf_page(split_points[i*rows:(i+1)*rows], rows)

def plot_single_pdf_page(split_points, rows, size=(8.27, 11.69)):
	...
	axs[0].set_title('Elevation [ft]; Distance [mi]; 1 mi = 1.6 km; 1000 ft = 300 m')
